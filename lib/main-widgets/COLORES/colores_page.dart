...
import 'package:zapatito_v2/main-widgets/COLORES/colores_form.dart';
...
class _ColoresPageState extends State<ColoresPage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '¿Seguro que deseas eliminar el color "$nombre"? Esta acción no se puede deshacer.',
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      try {
                        final bool exito = await ColoresService.eliminar(id);
                        ...
                        if (mounted) {
                          if (exito) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('Color quitado de la lista correctamente 🗑️'),
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('No se pudo eliminar el color'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Designwidgets().appBarMain('Colores'),
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: ColoresService.obtenerPorInventario(widget.inventarioId ?? ''),
        builder: (context, snapshot) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final String id = data['id_color']?.toString() ?? '';
