...
import 'package:zapatito_v2/main-widgets/TIENDA/tienda_form.dart';
...
class _TiendaPageState extends State<TiendaPage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '¿Seguro que deseas eliminar la tienda "$nombre"? Esta acción no se puede deshacer.',
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      try {
                        final bool exito = await TiendaService.eliminar(id);
                        ...
                        if (mounted) {
                          if (exito) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text(
                                    'Tienda quitada de la lista correctamente 🗑️'),
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('No se pudo eliminar la tienda'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Designwidgets().appBarMain('Tiendas'),
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future:
            TiendaService.obtenerPorInventario(widget.inventarioId ?? ''),
        builder: (context, snapshot) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final String id = data['id_tienda']?.toString() ?? '';
